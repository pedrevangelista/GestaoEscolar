/*
 * Jframe utilizada para a matricula de um aluno em uma turma
 */
 ...
 * @author Pedro Lucas
 */
public class TelaInscricaoTurma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnMostrar.setText("Mostrar materias e alunos inscritos");
        btnMostrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMostrarActionPerformed(evt);
            }
        });
        jPanel1.add(btnMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(294, 420, 233, -1));

        btnCadTurma.setBackground(new java.awt.Color(255, 204, 204));
        btnCadTurma.setText("Inscrever Aluno");
        btnCadTurma.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCadTurmaActionPerformed(evt);
            }
        });
        jPanel1.add(btnCadTurma, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 134, 15));
        ...
        edtSemestre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                edtSemestreActionPerformed(evt);
            }
        });
        jPanel1.add(edtSemestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(74, 22, 120, 31));

        btnAtualizar.setBackground(new java.awt.Color(255, 204, 204));
        ...
        jPanel1.add(btnAtualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 180, -1));

        btnTrancar.setBackground(new java.awt.Color(255, 153, 153));
        btnTrancar.setText("Trancar Materia");
        btnTrancar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTrancarActionPerformed(evt);
            }
        });
        jPanel1.add(btnTrancar, new org.netbeans.lib.awtextra.AbsoluteConstraints(533, 420, 242, -1));

        btnHistorico.setBackground(new java.awt.Color(255, 204, 204));
        btnHistorico.setText("Ver Historico");
        btnHistorico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnHistoricoActionPerformed(evt);
            }
        });
        jPanel1.add(btnHistorico, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 420, 134, 15));
    ...
    private void btnCadTurmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadTurmaActionPerformed
        ...
        for (Turma pp : Turma.listaDeTurmasPInscrever()) {
        ...
        for (Turma iaba: aa.getListaDeMateriasFeitas()){
            if (iam.getId().equals(iaba.getId()) && iam.getSemestre()==iaba.getSemestre()){
                
                JOptionPane.showMessageDialog(this, "Ja esta inscrito nessa materia em outra turma");
                g=1;
            }
        }
        ...
        if (aa.getHistorico().getListaDeSemestre().size() > 0) {
            if (iam.getPre_requisito().isEmpty()) {
                iam.listaDeAlunosNaTurma().add(aa);
                        aa.getListaDeMateriasFeitas().add(iam);
                        aa.gravarAlunoIAMTxt();
                        JOptionPane.showMessageDialog(this, "Matriculado na materia");
            } else {
                y = aa.verificarPreRequisito(iam.getPre_requisito());
                if (y == 1) {
                    System.out.println("Possui pre requisito");
                    iam.listaDeAlunosNaTurma().add(aa);
                        aa.getListaDeMateriasFeitas().add(iam);
                        aa.gravarAlunoIAMTxt();
                        JOptionPane.showMessageDialog(this, "Matriculado na materia");
                ...
                if (y == 0) {
                    if (iam.getPre_requisito().isEmpty()) {
                        ...
                        JOptionPane.showMessageDialog(this, "Não possui pre requisito");
                    }
                }
            ...
            if ("".equals(iam.getPre_requisito())){
                iam.listaDeAlunosNaTurma().add(aa);
                aa.getListaDeMateriasFeitas().add(iam);
                aa.gravarAlunoIAMTxt();
                JOptionPane.showMessageDialog(this, "Matriculado na materia");
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        ...
        for (int i = 0; i < Turma.listaDeTurmasPInscrever().size(); i++) {
            if (Turma.listaDeTurmasPInscrever().get(i).getSemestre()==Integer.valueOf(edtSemestre.getText())){
                String nome = Turma.listaDeTurmasPInscrever().get(i).getNome();
                String id = Turma.listaDeTurmasPInscrever().get(i).getId();
                String prof = Turma.listaDeTurmasPInscrever().get(i).getProfessor().getNome() + "(" + Turma.listaDeTurmasPInscrever().get(i).getProfessor().getMatricula() + ")";
                int sem = Turma.listaDeTurmasPInscrever().get(i).getSemestre();
    ...
    private void edtSemestreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edtSemestreActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_edtSemestreActionPerformed

    private void btnTrancarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTrancarActionPerformed
        // TODO add your handling code here:
        TelaTrancarMateria tl = null;
        tl = new TelaTrancarMateria();
    ...
    private void btnHistoricoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHistoricoActionPerformed
        Aluno aa;
        if (matriculaAdmin==null)
            aa = (Aluno) login;
        else
            aa = Aluno.VerificaAluno(matriculaAdmin);
        System.out.println(matriculaAdmin);
        String a = "";
        aa = Aluno.VerificaAluno(aa.getMatricula());
